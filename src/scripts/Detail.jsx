    ...
    render() {
        ...
        return (
            <div className="col-xs-12 detail-all">
                <div className="panel panel-dark col-xs-6 detail-panel">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <ul className="list-unstyled weather-info">
                                        ...
                                        <li><DetailGauge value={data.ch1.fq} ref={(ref) => this.detailGaugeCh1 = ref} /></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6">
                                    <ul className="list-unstyled weather-info">
                                        ...
                                        <li><DetailGauge value={data.ch2.fq} ref={(ref) => this.detailGaugeCh2 = ref} /></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
